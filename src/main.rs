...
fn main() {
    ...
    while points_0 > 0 && points_1 > 0 {
        const SEED1: &str =
            "lunar antique thank school space garden soda cigar glove despair master pumpkin";
        const SEED2: &str =
            "parade method erupt shock bacon wait follow limb onion laugh exhibit whip";
